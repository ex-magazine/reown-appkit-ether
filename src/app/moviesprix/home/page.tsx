import RatingCompComponent from '@/components/moviesprix/client/rating';
import MovieCard from '@/components/moviesprix/movie-card';
import SearchBar from '@/components/moviesprix/search-bar';
import TrendingSection from '@/components/moviesprix/trending-section';
import {
  Card,
  CardContent,
  CardDescription,
...
import { ScrollArea, ScrollBar } from '@/components/moviesprix/ui/scroll-area';
...
export default async function Home() {
  ...
  return (
    <div className="grid w-full gap-5 2xl:gap-8">
