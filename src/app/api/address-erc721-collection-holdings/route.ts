...
export async function POST(request: Request){
    ...
    const response = await fetch('https://deep-index.moralis.io/api/v2.2/' + body.address + '/nft/collections?chain=' + body.network, options) // Pass in address and chain values
