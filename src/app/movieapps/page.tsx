...
import { BannerSkeleton } from '@/components/ether/movieapps/Banner';
...
import { AnimatedGridPattern } from '@/components/ether/moviesprix/ui/animated-grid-pattern';
import { AnimatedGradientText } from '@/components/ether/moviesprix/ui/animated-gradient-text';

const Banner = dynamic(() => import('@/components/ether/movieapps/Banner'), {
  ssr: true,
});
