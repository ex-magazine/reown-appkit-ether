...
// Custom Error Page for the ERC721 Collections Page
export default function ERC721CollectionsErrorPage({
  error
}: {
  ...
  // Render Custom Error Page for ERC721 Collections
  return (
    <div className="bg-gray-800 text-gray-300 py-10 px-4 sm:px-6 lg:px-8 shadow-lg">
      <div className="text-center">
        <AlertCircle className="mx-auto h-12 w-12 text-gray-400 mb-4" />
        <h3 className="text-3xl font-bold text-gray-100 mb-4">Error Loading ERC721 Collection</h3>
        <p className="text-xl text-gray-400 mb-8">
          We are having trouble retrieving the ERC721 Collection page. This could likely be due to network issues.
          <br />
        </p>
