...
export default function GasBlockInfoTable() {
  const gasMetricsInfo = useSWR('/api/navbar/gas-track', GenericFetcher, {
  ...
  if (isLoading) {
    ...
    const gasBlockData: GasBlockInfoType[] =
      data.blockPrices[0].estimatedPrices;
