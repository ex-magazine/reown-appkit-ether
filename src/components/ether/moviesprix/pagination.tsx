...
import {
  ...
  PaginationNext,
  PaginationPrevious,
} from '@/components/ether/moviesprix/ui/pagination';
  ...
  return (
    <Pagination>
      <PaginationContent>
        ...
        {current > 2 && (
          <PaginationItem className="max-md:hidden">
            <PaginationLink href={`${path}?page=${current - 2}`}>
              {current - 2}
            </PaginationLink>
          </PaginationItem>
        )}
        ...
        {current > 1 && (
          <PaginationItem>
            <PaginationLink href={`${path}?page=${current - 1}`}>
              {current - 1}
            </PaginationLink>
          </PaginationItem>
        )}
        ...
        {current < total - 2 && (
          <PaginationItem className="max-md:hidden">
            <PaginationLink href={`${path}?page=${total}`}>
              {total}
            </PaginationLink>
          </PaginationItem>
        )}
