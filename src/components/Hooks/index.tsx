...
export default function Hooks() {
  ...
  if (!address && mounted) {
    return (
      <button
        ...
        className={`rounded-md bg-green-600 px-6 py-2 text-white transition-all duration-300 ${
  ...
  return (
    ...
    address && (
      <div className="flex items-center space-x-4">
        <button
          className="cursor-pointer rounded-md bg-gray-800 px-4 py-2 text-white transition-all duration-300 hover:bg-gray-700"
          onClick={() => open({ view: 'Account' })}
        >
          {shortenAddress(address)}
        </button>
