...
export default function ERC20TokenPricesInfoTable(props: {
  ...
  return (
    <div className="mt-10 bg-gray-900 p-4 shadow-lg">
      <h2 className="mb-4 text-2xl font-bold text-gray-100">Pricing Data</h2>
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="text-gray-300">
              Market Data Attribute
            </TableHead>
