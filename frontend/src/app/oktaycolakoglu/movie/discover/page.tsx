...
import { DiscoverFilters } from "@/components/ether/oktaycolakoglu/discover-filters"
import { DiscoverSort } from "@/components/ether/oktaycolakoglu/discover-sort"
  ...
  return (
    <div className="container space-y-8 mx-auto">
      ...
      {movies.length ? (
        ...
        <div className="container flex justify-center pb-[30dvh] mx-auto">
