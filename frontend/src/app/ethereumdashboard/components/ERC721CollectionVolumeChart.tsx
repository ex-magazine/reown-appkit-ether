...
export default function ERC721CollectionVolumeChart(props: {
  ...
  const {
    data: erc721CollectionVolumeData,
    error: erc721CollectionVolumeError,
    isLoading: erc721CollectionVolumeLoading,
  } = useSWR(
    ...
    return (
      <div>
        <p className="text-white-100">
          Loading ERC721 Collection Volume Chart Data...
        </p>
      </div>
    );
  } else {
