...
export default function ERC20HoldingsForm() {
  ...
  const [erc20Transfers, updateERC20Transfers] =
    useState<ERC20TransfersType[]>();
      ...
      <div className="container mx-auto w-full max-w-3xl px-4">
        {showAlert && (
          <Alert variant="destructive" className="mb-6">
            <AlertDescription>
              There was an error processing your request. Please enter a valid
              wallet address.
            </AlertDescription>
          </Alert>
        )}
        <Card className="mt-10 w-full border-gray-800 bg-gray-900 shadow-xl">
