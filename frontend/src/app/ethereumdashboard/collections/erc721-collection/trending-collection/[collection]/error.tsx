...
// Custom Error Page for the Trending Collections Pages
export default function TrendingCollectionsPageError({
  error,
}: {
    ...
    <div className="bg-gray-800 px-4 py-10 text-gray-300 shadow-lg sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <h3 className="mb-4 text-3xl font-bold text-gray-100">
          Error Loading Trending Collection
        </h3>
        <p className="mb-8 text-xl text-gray-400">
          We are having trouble retrieving the data of this particular NFT
          collection. This could be due to network issues or an invalid
          collection ID.
          <br />
          <b>
            If a collection is not deployed on Ethereum, we cannot provide
            information for it at this time.
          </b>
        </p>
