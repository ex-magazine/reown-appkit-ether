    ...
    <div className="bg-gray-800 px-4 py-10 text-gray-300 shadow-lg sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <h3 className="mb-4 text-3xl font-bold text-gray-100">
          Error Loading ERC721 Lookups Data
        </h3>
        <p className="mb-8 text-xl text-gray-400">
          We are having trouble retrieving ERC721 lookups data. This could be
          due to network issues or an invalid contract address.
        </p>
