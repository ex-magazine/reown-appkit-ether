import RatingCompComponent from '@/components/ether/moviesprix/client/rating';
import MovieCard from '@/components/ether/moviesprix//movie-card';
import SearchBar from '@/components/ether/moviesprix//search-bar';
import TrendingSection from '@/components/ether/moviesprix/trending-section';
import {
  Card,
  CardContent,
  CardDescription,
  ...
  CardHeader,
  CardTitle,
} from '@/components/ether/moviesprix/ui/card';
import {
  ScrollArea,
  ScrollBar,
} from '@/components/ether/moviesprix/ui/scroll-area';
...
const CategoriesList = [
  ...
  },
  {
    ...
    description:
      'Dive into terrifying tales that will keep you on the edge of your seat',
  ...
  },
  {
    ...
    description:
      'Discover futuristic worlds and mind-blowing sci-fi adventures',
    queryFn: discoverMovies({ with_genres: '878', sort_by: 'vote_count.desc' }),
  },
  {
    title: 'Best Crime Movies',
    description:
      'Uncover the best crime thrillers packed with suspense and mystery',
