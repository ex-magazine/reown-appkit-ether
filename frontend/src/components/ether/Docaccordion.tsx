...
const Docaccordion: React.FC = () => {
  const faqItems = [
    {
      id: '1', title: 'TOKENOMIC $UNI #Uniswap',
      content: 'Tạo ra khoảng $1,2 tỷ USD phí mỗi năm. 0.25% khối lượng giao dịch là interface fees ($5 - $10M mỗi tháng) chảy về túi Uniswap Labs, phần còn lại là LP fees thuộc về Liquidity Privider => UNI holder không nhận được giá trị gì, lmao. Ngoài ra, design tokenomic của UNI không giới hạn tổng cung.Initial total supply = 1B, sau khi vesting hết thì bắt đầu quá trình lạm phát vĩnh viễn 2% mỗi năm.Mặc dù con số này không quá lớn(~21 % sau 10 năm) nhưng đó là một khoản ăn mòn dần giá trị của holder.
    ...
    {
      id: '2', title: '$CAKE #Pancakeswap', content: 'Tạo ra khoảng $1.8 tỷ USD phí giao dịch mỗi năm, mang về $450M doanh thu và có tới $325M giá trị dành cho CAKE holder.
