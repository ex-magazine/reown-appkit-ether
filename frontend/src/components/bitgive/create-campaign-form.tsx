...
import { Textarea } from '@/components/bitgive/ui/textarea';
import {
  Select,
  SelectContent,
  SelectItem,
...
import {
  ...
  TabsList,
  TabsTrigger,
} from '@/components/bitgive/ui/tabs';
import {
  Bitcoin,
  Calendar,
  Clock,
...
export default function CreateCampaignForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(
        error?.message || 'Error creating campaign. Please try again.',
      );
    } finally {
            ...
            <div className="flex flex-col items-center justify-center py-10 text-center">
              ...
              <div className="flex sm:flex-row flex-col gap-4">
                <Button
                  ...
                  onClick={() => router.push('/bitgive/charities')}
                >
                  View All Charities
                </Button>
                <Button
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  All campaigns are reviewed by our team before being published.
                  This process typically takes 24-48 hours. You'll be notified
          ...
          <Tabs defaultValue="preview" className="w-full">
            ...
            <TabsContent value="preview" className="mt-4 space-y-4">
              ...
              {formData.impacts.filter((impact) => impact.trim() !== '')
                .length > 0 && (
                <div className="rounded-lg border border-border/40 bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm p-4">
                  <h4 className="text-sm font-medium mb-2">Campaign Impact</h4>
              ...
              <div className="rounded-lg border border-border/40 bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {formData.impacts.filter((i) => i.trim() !== '').length}
                    </span>
                  </div>
                </div>
              </div>
