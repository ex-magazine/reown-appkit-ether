...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      {/* Sidebar - Desktop */}
      <aside className="inset-y-0 left-0 z-50 hidden w-64 flex-col border-r border-border/40 bg-card/30 backdrop-blur-sm md:flex">
        <div className="flex h-16 items-center border-b border-border/40 px-4">
          <Link href="/bitgive" className="flex items-center gap-2">
      ...
      <div className="flex flex-1 flex-col md:ml-0">
        ...
        {/* Footer */}
        <footer className="border-t border-border/40 bg-card/30 backdrop-blur-sm p-6 text-center text-sm text-muted-foreground">
