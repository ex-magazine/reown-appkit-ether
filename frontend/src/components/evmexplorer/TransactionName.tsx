      ...
      {transactionAddressData && (
        <div>
          {transactionAddressData.ens_domain_name ? (
            <Link
              href={`/evmexplorer/contracts/${network}/${transactionAddressData.hash}`}
            ...
            <Link
              href={`/evmexplorer/contracts/${network}/${transactionAddressData?.hash ?? '0x0000000000000000000000000000000000000000'}`}
