...
import { ContractListItem } from '@/components/evmexplorer/ContractListItem';
    ...
    return (
      ...
      contract.addresses.some(
        (address: ContractData) =>
          address.network.toLowerCase() === chain.value,
      )
    );
  });
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full space-y-12 text-center">
        ...
        <div className="flex items-center justify-center mt-10 fade-in-2s sm:mb-8">
          <Image
        ...
        <div className="max-w-6xl flex items-center justify-center fade-in-text mx-auto">
