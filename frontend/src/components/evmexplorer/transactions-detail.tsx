...
import { useTransactionBlockscout } from '@/hooks/evmexplorer/blockscout';
import { useTransaction } from '@/hooks/evmexplorer/viem';
...
export default function TransactionDetail({
  ...
  const path: string =
    '/evmexplorer/transactions/' + networkQuery + '/' + String(hash);
      ...
      {isFetched && transactionData && hashData ? (
        <div className="mx-auto w-full space-y-12 text-center">
          ...
          <div className="font-serif mb-6 sm:mb-10">
            <p className="mt-2">
              <Link
                href={`/evmexplorer/blocks/${networkName}/${hashData.blockNumber}`}
          ...
          <div className="px-8 font-mono">
            <div className="mt-5">
              <div className="flex items-center justify-center bg-emerald-300 pt-3 pb-3 pr-6 pl-3 rounded-lg ">
                <span className="text-gray-700">From</span>
                <div className="ml-2 break-words">
                  <Link
                    href={`/evmexplorer/contracts/${network}/${hashData.from}`}
                  ...
                  (parameter: TransactionParameter) => (
                    <div key={parameter.name} className="mt-1 break-words">
                      ...
                      {parameter.type === 'address' ? (
                        <Link
                          href={`/evmexplorer/contracts/${network}/${parameter.value}`}
            ...
            <div className="mt-6">
              <div className="flex items-center justify-center bg-[#e76e9e] pt-3 pb-3 pr-3 pl-6 rounded-lg">
                <span className="text-gray-200">To</span>
                <div className="ml-2">
                  <Link
                    href={`/evmexplorer/contracts/${network}/${hashData.to ?? '0x0000000000000000000000000000000000000000'}`}
            ...
            <div className="mt-6 bg-[#6e9ee7] rounded-lg">
                    ...
                    (token: TokenTransferBlockscout) => (
                      ...
                      >
                        <div>
                          From:
                          <Link
                            href={`/evmexplorer/contracts/${network}/${token.from.hash ?? '0x0000000000000000000000000000000000000000'}`}
                        ...
                        <div>
                          To:
                          <Link
                            href={`/evmexplorer/contracts/${network}/${token.to.hash ?? '0x0000000000000000000000000000000000000000'}`}
                        ...
                        <div className="mx-auto fade-in-1s mt-2">
                          <div className="flex items-center justify-center">
                            ...
                            <Link
                              href={`/evmexplorer/contracts/${network}/${token.token.address ?? '0x0000000000000000000000000000000000000000'}`}
